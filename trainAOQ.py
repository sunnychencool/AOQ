...
from modelAOQ import VSRN
from evaluationAOQ import i2t, t2i, AverageMeter, LogCollector, encode_data
import logging
...
def main():
    ...
    parser.add_argument('--offcandipath', default='./offlinecandidates/',
                        help='Path to saved vocabulary pickle files.')
    parser.add_argument('--marginonline', default=0.2, type=float,
                        help='Rank loss margin.')
    parser.add_argument('--marginoffline', default=0.0, type=float,
                        help='Rank loss margin.')
    parser.add_argument('--alpha', default=0.3, type=float,
                        help='Adaptive Penalization Parameter.')
    parser.add_argument('--beta', default=1.5, type=float,
                        help='Adaptive Penalization Parameter.')
    parser.add_argument('--offcandisize', default=300, type=float,
                        help='Top candidate list size to sample offline hard negative text')
    parser.add_argument('--num_epochs', default=20, type=int,
                        help='Number of training epochs.')
    parser.add_argument('--batch_size', default=124, type=int,
    ...
    # Load data loaders
    train_loader, val_loader = dataAOQ.get_loaders(
        opt.data_name, vocab, opt.offcandipath, opt.offcandisize, opt.crop_size, opt.batch_size, opt.workers, opt)
