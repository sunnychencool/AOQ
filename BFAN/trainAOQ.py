...
from modelAOQ import BFAN
from evaluationAOQ import i2t, t2i, AverageMeter, LogCollector, encode_data, shard_xattn
...
def main():
    ...
    train_loader, val_loader = dataAOQ.get_loaders(
        opt.data_name, vocab, opt.offcandipath, opt.offcandisize, opt.batch_size, opt.workers, opt)
